...
gph2fmt "fig/gph/`file_name_base'.gph", ///
	...
	bare_file("fig/eps/cuts/`file_name_base'_bare.eps")
	*titleless_file("fig/eps/cuts/`file_name_base'_notitle.eps")
if "`ext_fmt'"!=""{
	gph2fmt "fig/gph/`file_name_base'.gph", ///
		plain_file("fig/`ext_fmt'/`file_name_base'.`ext_fmt'")  ///
		bare_file("fig/`ext_fmt'/cuts/`file_name_base'_bare.`ext_fmt'")
		*titleless_file("fig/`ext_fmt'/cuts/`file_name_base'_notitle.`ext_fmt'")
}
